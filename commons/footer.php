...
<footer class="footer">
  <div class="footer__content">
    <div class="footer__copyright">
      <span>Hak cipta &copy; <?= date('Y') ?> - <a href="https://www.facebook.com/pandutalentadigital" target="_blank"><strong>SiDePe <?= THEME_VERSION ?></strong></a> | <a href="https://github.com/opensid/opensid/"><strong>OpenSID <?= ambilVersi() ?></strong></a></span>
    </div>
