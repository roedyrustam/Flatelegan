...
<meta name='designer' content='Roedy Rustam' />
<meta name='theme:designer' content='Roedy Rustam' />
...
<?php else : ?>
  <title><?php $tmp = ltrim(get_dynamic_title_page_from_path(), ' -');
          echo (trim($tmp) == '') ? "Sistem Informasi " . $desa_title : "$tmp - $desa_title"; ?></title>
  ...
  <meta property="og:title" content="<?php $tmp = ltrim(get_dynamic_title_page_from_path(), ' -');
                                      echo (trim($tmp) == '') ? $desa_title : "$tmp - $desa_title"; ?>" />
